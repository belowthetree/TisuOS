...
use crate::{libs::str::{check_sum, make_shortname}, memory::block::new_block, uart, virtio::buffer::{sync_read_buffer, sync_write_buffer, sync_write_zero}};
...
impl IO for FATManger {
    fn read(&mut self, block_idx : usize, cluster : usize, offset : usize, len : usize)->Option<Box<crate::memory::block::Block>> {
