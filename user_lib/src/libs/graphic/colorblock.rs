...
impl ColorBlock {
    ...
    pub fn draw_area(&self, h1 : usize, h2 : usize) {
        ...
        draw_rect_override(rect, self.buffer.array(0, self.buffer.size));
    }
    /// ### 绘制缓冲全部区域
    ...
    pub fn draw_blend(&self) {
        ...
        draw_rect_blend(rect, self.buffer.array(0, self.buffer.size));
    }
    /// ### 写字
...
use crate::{libs::memory_block::Block};

use super::{Rect, Vector, draw_rect_blend, draw_rect_override, font::{FONT_ASCII, FONT_HEIGHT, FONT_WIDTH}};
